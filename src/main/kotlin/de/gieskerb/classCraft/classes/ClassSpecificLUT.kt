...
object ClassSpecificLUT {
    ...
    var farmerBlocks: MutableList<MaterialPair>? = null
        get() {
            if (field == null) {
                ...
                field!!.add(MaterialPair(Material.WHEAT, 20))
                field!!.add(MaterialPair(Material.CARROTS, 20))
                field!!.add(MaterialPair(Material.POTATOES, 20))
                field!!.add(MaterialPair(Material.COCOA, 20))
                field!!.add(MaterialPair(Material.PUMPKIN_STEM, 20))
                field!!.add(MaterialPair(Material.ATTACHED_PUMPKIN_STEM, 20))
                field!!.add(MaterialPair(Material.MELON_STEM, 20))
                field!!.add(MaterialPair(Material.ATTACHED_MELON_STEM, 20))
                field!!.add(MaterialPair(Material.BEETROOTS, 20))
    ...
    fun getMaxAge(material: Material): Int {
        if (ageTable == null) {
            ...
            ageTable!![Material.WHEAT] = 7
            ageTable!![Material.CARROTS] = 7
            ageTable!![Material.POTATOES] = 7
            ageTable!![Material.PUMPKIN_STEM] = 7
            ageTable!![Material.ATTACHED_PUMPKIN_STEM] = 7
            ageTable!![Material.MELON_STEM] = 7
            ageTable!![Material.ATTACHED_MELON_STEM] = 7
            ageTable!![Material.BEETROOTS] = 3
    ...
    data class EntityPair(val type: EntityType, val xpValue: Int) {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (other !is EntityPair) return false
    ...
    data class MaterialPair(val type: Material, val xpValue: Int) {
        ...
        override fun equals(other: Any?): Boolean {
            if (this === other) return true
            if (other !is MaterialPair) return false
            return type == other.type
        }
