...
public class ExplorerClass extends BaseClass {

    public final static String CLASS_NAME = "Explorer";
    private static ItemStack displayItem = null;

    public ExplorerClass(Player player) {
        super(ExplorerClass.CLASS_NAME, player);
    }

    public ExplorerClass(JSONObject json, Player player) {
        super(json, player);
    }

    public static ItemStack getDisplayItem() {
        if (displayItem == null) {
            displayItem = new ItemStack(Material.NETHERITE_BOOTS);
